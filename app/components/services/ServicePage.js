...
const ServicesSection = () => {
  ...
  return (
    <section id="services" className="py-10 sm:py-14 md:py-16 bg-gray-50">
      <div className="container mx-auto px-2 sm:px-4 max-w-7xl">
        ...
        >
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-2xl sm:max-w-3xl mx-auto">
            Comprehensive pest control solutions tailored to your specific
            needs. We use safe, effective methods to eliminate pests and prevent
            future infestations.
          </p>
        </motion.div>
          ...
          {services.map((service, index) => (
            <motion.div
              ...
              className={`bg-white rounded-lg shadow-md overflow-hidden transition-all duration-300 ${
                expandedService === service.id ? "shadow-xl" : "hover:shadow-lg"
              } flex flex-col`}
            >
              <div
        ...
        {/* Bird Section */}
        <motion.div
          className="mt-10 sm:mt-16 bg-green-50 rounded-lg p-4 sm:p-8"
